...
`
  ...
  anthologies = `
<span><i>Sweet Water: Poems for the Watersheds, Yvonne Blomer</i> (Caitlin Press, 2020 upcoming) </span>
...
<span><i>Poet to Poet</i>, ed. Julia Roorda and Elana Wolff (Guernica, 2012). ISBN 978-1-5507-645-0</span>
...
<span><i>Land/Space: An Anthology of Speculative Prairie Literature</i> (Tesseract, 2003). IBSN: 1-895836-92-. (98-100, 184-6)Mekler & Deahl, 2000</span>

<span><i>The Common Sky: Poems against the US-led Invasion of Iraq</i> (Threesquare Press, 2003). 	
IBSN: 0-9732578-0-6</span>

<span><i>No Choice but to Trust</i> (Mekler & Deahl, 2000). IBSN, 1-884206-08-5</span>

<span><i>Waiting for you to Speak</i> (Mekler & Deahl, 1999). IBSN: 1-884206-05-0</span>
`;
